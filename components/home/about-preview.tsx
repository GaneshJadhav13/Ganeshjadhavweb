		...
		<section className="py-16 md:py-24">
			<div className="container px-4">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
					...
					>
						<h3 className="text-2xl font-bold mb-4">Professional Developer</h3>
						<p className="text-muted-foreground mb-6">
							I'm a dedicated BCA student with a passion for innovation and problem-solving.
							My academic journey has equipped me with strong technical skills and a deep understanding
							of programming principles that I apply to real-world challenges.
						</p>
						...
						<div className="grid grid-cols-2 gap-4 mb-6">
							<Card className="card-gradient">
								<CardContent className="p-4">
									...
									<p className="text-sm text-muted-foreground">BCA Science</p>
								</CardContent>
							</Card>
							<Card className="card-gradient">
								<CardContent className="p-4">
